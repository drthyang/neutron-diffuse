...
Motivation
----------
The parametric :class:`~nebula3d.preprocessing.ring_model.PatchedRingModel` models
...
class PatchedRadialRingModel:
    ...
    ring_templates : sequence, optional
        ...
        attributes (e.g. :class:`~nebula3d.preprocessing.powder_rings.RingProfile`)
        or a ``(q_center, sigma)`` tuple — typically from a Bragg-free linecut
        (:func:`~nebula3d.preprocessing.powder_rings.fit_ring_profiles`).  When
