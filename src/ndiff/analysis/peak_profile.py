...
:mod:`ndiff.analysis.bragg` / :mod:`ndiff.analysis.bragg_fill` destroys exactly
...
:func:`ndiff.preprocessing.powder_rings.fit_ring_profiles`; peak finding reuses
:class:`ndiff.analysis.bragg.BraggRemover`.
"""
...
def magnetic_satellite_centers(
    ...
    *,
    ...
    :class:`~ndiff.analysis.bragg.BraggRemover` to the fractional-H planes, then
