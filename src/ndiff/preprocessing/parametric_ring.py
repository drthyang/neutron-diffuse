...
-----------------------------------------------
The non-parametric :class:`~ndiff.preprocessing.radial_background.PatchedRadialRingModel`
...
older shared-texture :class:`~ndiff.preprocessing.ring_model.PatchedRingModel`.
...
class ParametricRingModel:
    ...
    allowed_ring_centers, allowed_ring_halfwidths : array, optional
        ...
        :func:`~ndiff.preprocessing.radial_background.confirm_ring_shells_across_h`.
